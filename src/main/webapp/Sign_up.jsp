...
<title>Register with Home Finder</title>
<!-- Meta tag Keywords -->
...
<!--header-->
	<div class="header-w3l">
		<h1>Join Home Finder and find your home</h1>
	</div>
<!--//header-->
<!--main-->
<div class="main-agileits">
	<h2 class="sub-head">Sign Up</h2>
		<div class="sub-main">	
			<form action="SignupContainer" method="post">
				...
				<input placeholder="Address" name="address" class="name2" type="text" required="">
					<span class="icon2"><i class="fa fa-user" aria-hidden="true"></i></span><br>
				<input placeholder="Credit Card number" name="ccard" class="name2" type="text" required="">
					<span class="icon2"><i class="fa fa-user" aria-hidden="true"></i></span><br>
				<input placeholder="Gender(Male or Female)" name="gender" class="name2" type="text" required="">
					<span class="icon2"><i class="fa fa-user" aria-hidden="true"></i></span><br>
